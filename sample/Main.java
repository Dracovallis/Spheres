...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Label gameInstructions = new Label("W,A,S,D or Up,Left,Down,Right -> Move Sphere\n" +
                "SHIFT -> Sprint\n" +
                "P -> Pause\n" +
...
//        rt.play();
        ...
        //Sound effects
        String startGameSound = "start-game-sound-effect.wav";
        String gameOverSound = "";
        InputStream is = getClass().getClassLoader().getResourceAsStream("game-music.wav");
    ...
    private void collisionChecker(List<ImageView> enemyList) throws IOException {
        for (ImageView enemy : enemyList) {
            ...
            String absorbSphereSound = "absorb-sphere-sound-effect.wav";
...
//            rt.play();
   ...
   private void playSound(String path) throws IOException {
